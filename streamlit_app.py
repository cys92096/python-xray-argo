...
UUID = os.environ.get('UUID', 'd4d586b7-e2d3-4792-b742-20d97cd74db9')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'd.ccyyss.qzz.io')          # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', '{"AccountTag":"751e7f39e90d4ccc782e06520e915abe","TunnelSecret":"Ps/TzT8iOF9FNmt0+I7+lsDKpolf42CsNOlNuTCWMb0=","TunnelID":"aa4f5f0a-67f1-48ac-97b0-fd52acc46004","Endpoint":""}')              # Argo固定隧道密钥,留空即使用临时隧道
ARGO_PORT = int(os.environ.get('PORT', '8001'))
CFIP = os.environ.get('CFIP', 'cf.mugongzi123.gq')          # 优选ip或优选域名
